...
(define make-global-env-default
  (lambda ()
    (list
...
(define make-global-env-arduino
  (lambda ()
    (list
     (make-var '#%number? #t '() '() '() #f (make-primitive 1 #f #f))
     (make-var '#%+ #t '() '() '() #f (make-primitive 2 #f #f))
     ...
     (make-var '#%print #t '() '() '() #f (make-primitive 1 #f #t))
     (make-var '#%clock #t '() '() '() #f (make-primitive 0 #f #f))
     (make-var '#%pin-mode #t '() '() '() #f (make-primitive 2 #f #t))
     (make-var '#%digital-write #t '() '() '() #f (make-primitive 2 #f #t))
     (make-var '#%led2-color #t '() '() '() #f (make-primitive 1 #f #t))
     (make-var '#%getchar-wait #t '() '() '() #f (make-primitive 2 #f #f))
     (make-var '#%putchar #t '() '() '() #f (make-primitive 2 #f #t))
     (make-var '#%beep #t '() '() '() #f (make-primitive 2 #f #f))
...
(define make-global-env
  (if (equal? arch 'arduino)
      make-global-env-arduino
      make-global-env-default))
...
;; (define foo car)
(define substitute-primitives-default
  '((number? . #%number?)
    (remainder . #%remainder)
    (= . #%=)
    (< . #%<)
...
(define substitute-primitives-arduino
  '((number? . #%number?)
    (remainder . #%remainder)
    (= . #%=)
    (< . #%<)
...
(define substitute-primitives
  (if (equal? arch 'arduino)
      substitute-primitives-arduino
      substitute-primitives-default))
